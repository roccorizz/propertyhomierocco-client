    ...
    const handleGoogleSignIn = () => {
        providerLogin(googleProvider)
            .then((result) => {
                ...
                fetch('https://property-homie-rocco-server-roccorizz.vercel.app/jwt', {
                    method: 'POST',
                    headers: {
                    ...
                    .then(data => {
                        ...
                        localStorage.setItem('propertyhomierocco', data.token);
                ...
                <div>
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 mb-10">
                        <div className="card-body">
                            ...
                            <hr></hr>
                            <h6 className='text-center mt-5 mb-5'>Don't have an account? <Link to='/signup' className='text-accent font-bold'>Sign Up</Link></h6>
                        </div>
                    </div>
                </div>
            </div>
